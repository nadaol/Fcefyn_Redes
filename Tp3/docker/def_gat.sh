...
#agrego ruta estatica para no tener que correr ospf en la interface de h1 para el trafico del servidor a h1
...
#R4 :para no tener que redistribuir ospf a bgp agrego ruta estatica para el trafico de AS103 hacia AS101
