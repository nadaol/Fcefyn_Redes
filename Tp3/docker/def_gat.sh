...
sudo docker exec -ti --privileged docker_h1_1 ip -6 route add default via 2001:24::11 dev eth0
...
sudo docker exec -ti --privileged docker_h2_1 ip -6 route add default via 2001:22::10 dev eth0
...
sudo docker exec -ti --privileged docker_h3_1 ip -6 route add default via 2001:23::11 dev eth0
...
sudo docker exec -ti --privileged docker_ws_1 ip -6 route add default via 2001:25::11 dev eth0
...
sudo docker exec -ti --privileged docker_r2_1 ip -6 route add 2001:24:: via 2001:16::11
